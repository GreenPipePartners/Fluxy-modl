...
This record documents ownership of the Fluxy Java source published in this repository.

## Audit Result

- Repository history currently contains one identified individual author: Bobby Miller (`miller.bobby@gmail.com`).
- The Gateway module was developed in the Fluxy repository before publication in this standalone corresponding-source repository.
...
On July 12, 2026, Bobby Miller confirmed that work created after the recorded assignment is covered by a continuing written agreement with Green Pipe Partners, LLC. The confidential agreement is maintained outside this repository. External contributions remain subject to the contribution gate below.

## Contribution Gate

Do not merge an external contribution until the company contribution agreement process is operational and the contributor's individual or corporate agreement is recorded. See `CONTRIBUTING.md`.
