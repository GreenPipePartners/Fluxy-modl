...
public final class FluxyGatewayHook extends AbstractGatewayModuleHook {
    private static final LoggerEx LOG = LogUtil.getLogger("Fluxy.Module");
    ...
    public void startup(LicenseState licenseState) {
        ...
        LOG.info(
            "Fluxy Ignition 8.1 module started licenseMode=" + (FREE_MODULE ? "free" : "licensed")
        );
    }
    ...
    public void shutdown() {
        routes = null;
        context = null;
        LOG.info("Fluxy Ignition 8.1 module stopped");
    }
