...
The release tag for version `0.1.3.20260712` is:
...
python3 scripts/verify_release_artifact.py \
  release/Fluxy-Ignition81-Free-0.1.3.20260712.unsigned.modl \
  --ignition-version 8.1.50 \
  --source-commit "$COMMIT" \
  --source-tag "$TAG"

python3 scripts/verify_release_artifact.py \
  release/Fluxy-Ignition83-Free-0.1.3.20260712.unsigned.modl \
...
java -jar /secure/module-signer.jar \
  ...
  -module-in=release/Fluxy-Ignition83-Free-0.1.3.20260712.unsigned.modl \
  -module-out=release/Fluxy-Ignition83-Free-0.1.3.20260712.modl
```
