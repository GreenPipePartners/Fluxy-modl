...
The release tag for version `0.2.0.20260714` is:
...
python3 scripts/verify_release_artifact.py \
  release/Fluxy-Ignition81-Free-0.2.0.20260714.unsigned.modl \
  --ignition-version 8.1.50 \
  --source-commit "$COMMIT" \
  --source-tag "$TAG"

python3 scripts/verify_release_artifact.py \
  release/Fluxy-Ignition83-Free-0.2.0.20260714.unsigned.modl \
...
java -jar /secure/module-signer.jar \
  ...
  -module-in=release/Fluxy-Ignition83-Free-0.2.0.20260714.unsigned.modl \
  -module-out=release/Fluxy-Ignition83-Free-0.2.0.20260714.modl
```
